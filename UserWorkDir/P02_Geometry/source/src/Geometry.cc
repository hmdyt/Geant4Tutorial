...
//------------------------------------------------------------------------------
{
   ...
   auto solid_World = new G4Box("Solid_World", leng_X_World / 2.0, leng_Y_World / 2.0, leng_Z_World / 2.0);
   ...
   auto solid_WaterBox = new G4Box("Solid_WaterBox", leng_X_WaterBox / 2.0, leng_Y_WaterBox / 2.0, leng_Z_WaterBox / 2.0);

   // Define logical volume
   G4Material* materi_WaterBox = materi_Man->FindOrBuildMaterial("G4_WATER");
   auto logVol_WaterBox = new G4LogicalVolume(solid_WaterBox, materi_WaterBox, "LogVol_WaterBox", 0, 0, 0);
